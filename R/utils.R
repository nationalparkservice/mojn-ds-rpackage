...
GetColSpec <- function() {
  col.spec <- list(
    CalibrationDO = readr::cols(
      ...
      BaroPressure_mmHg = readr::col_double(),
      PreCal_percent = readr::col_double(),
      PreCalTemp_C = readr::col_double(),
      PostCal_percent = readr::col_double(),
      PostCalTemp_C = readr::col_double(),
      .default = readr::col_character()
    ),
    CalibrationpH = readr::cols(
      VisitDate = readr::col_date(),
      CalibrationDate = readr::col_date(),
      Standard_pH = readr::col_double(),
      TempCorrStandard_pH = readr::col_double(),
      PreCal_pH = readr::col_double(),
      PreCalTemp_C = readr::col_double(),
      PostCal_pH = readr::col_double(),
      PostCalTemp_C = readr::col_double(),
      .default = readr::col_character()
    ),
    CalibrationSpCond = readr::cols(
      VisitDate = readr::col_date(),
      CalibrationDate = readr::col_date(),
      Standard_uS_per_cm = readr::col_double(),
      PreCal_uS_per_cm = readr::col_double(),
      PostCal_uS_per_cm = readr::col_double(),
      .default = readr::col_character()
    ),
